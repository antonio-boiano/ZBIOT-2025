...
for category in ["Idle", "Physical_Interaction", "Scenario", "Web_Interaction"]:
    ...
    for topology in ["Topology_A", "Topology_B"]:
        ...
        for device_name_folder in os.listdir(topology_path):
            ...
            sequence_output_path = os.path.join(topology_path, "B_5_1-Sequence_Data_Fix_Packets")
            ...
            for file in os.listdir(raw_dataset_path):
                ...
                try:
                    ...
                    if "Device Name ZigBee" not in df.columns:
                        print(f"'Device Name ZigBee' not found in file: {file_path}")
                        continue
                    result_data = []
                    ...
                    for i in range(0, len(df) - WINDOW_SIZE + 1):
                        ...
                        if len(current_window["Device Name ZigBee"].unique()) > 1:
                            continue
                        ...
                        device_name = current_window["Device Name ZigBee"].iloc[0]
                        device_type = current_window["Device Type ZigBee"].iloc[0]
