...
input_folder = os.path.join("6-Merged_Data", "6-Merged_sequence_data_fix_durations")
output_folder = os.path.join( "8-Quantized_Data", "Quantized_values")
output_folder2 = os.path.join("8-Quantized_Data", "Quantized_index")
