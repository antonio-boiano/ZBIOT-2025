...
dataset_dir = "./Data"
aggregated_output_dir = "Merged_Data/B_6-Merged_sequence_data_fix_durations"
# aggregated_output_dir = "Merged_Data/B_6-Merged_sequence_data_fix_packets"
...
for topology in topologies:
    ...
    for category in categories:
        sequence_data_path = os.path.join(dataset_dir, category, topology, "B_5_2-Sequence_Data_Fix_Duration")
        # sequence_data_path = os.path.join(dataset_dir, category, topology, "B_5_1-Sequence_Data_Fix_Packets")
        ...
        for file in os.listdir(sequence_data_path):
            ...
            try:
                ...
                original_file_base = os.path.splitext(file.replace("_sort_sequence", ".pcapng"))[0]
