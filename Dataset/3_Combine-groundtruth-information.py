...
for category in ["Idle", "Physical_Interaction", "Scenario", "Web_Interaction"]:
    ...
    for topology in ["Topology_A", "Topology_B"]:
        ...
        combined_data_path = os.path.join(topology_path, "3-Combined_dataset")
        ...
        for file in os.listdir(os.path.join(topology_path, "2-Information_From_PCAP")):
            ...
            try:
                groundtruth_df = pd.read_csv(groundtruth_file_path,
                                             usecols=[ "Device Name","Device Type","Device Name Destination","Device Type Destination","Device Name ZigBee","Device Type ZigBee",
                                                       "Device Name ZigBee Destination","Device Type ZigBee Destination"])
            except ValueError:
                continue

            extracted_df = pd.read_csv(os.path.join(topology_path, "2-Information_From_PCAP", file))
